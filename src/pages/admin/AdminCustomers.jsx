                ...
                orderList.forEach(order => {
                    ...
                    if (!customerMap.has(userId)) {
                        customerMap.set(userId, {
                            id: userId,
                            name: order.user?.name || order.address?.fullname || "Unknown",
        ...
        <div className="p-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-slate-500 text-sm mt-1">Found {customers.length} unique customers from order history.</p>
                </div>
                    ...
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {loading ? (
                                    ...
                                    >
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div className="font-semibold text-slate-800 group-hover:text-blue-700 transition-colors">{customer.name}</div>
                                                    <div className="text-xs text-slate-400">ID: {customer.id.slice(0, 6)}...</div>
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr><td colSpan="6" className="p-8 text-center text-slate-500">No customers found matching your search.</td></tr>
                            )}
                        </tbody>
                    </table>
                </div>
