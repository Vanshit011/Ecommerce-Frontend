  ...
  return (
    <header className="relative z-50 bg-white/80 backdrop-blur-md border-b border-slate-200/60 shadow-sm transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between gap-6">
        ...
        >
          <div className="w-10 h-10 bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-xl flex items-center justify-center text-white shadow-lg shadow-indigo-200 group-hover:shadow-indigo-300 transition-all duration-300 group-hover:scale-105">
            <span className="font-black text-xl">S</span>
          </div>
          <div className="flex flex-col">
            <span className="text-xl font-black tracking-tight text-indigo-950 leading-none group-hover:text-indigo-600 transition-colors">
              SASTA<span className="text-indigo-600">STORE</span>
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={profileRef}>
            <button
              ...
              className={`flex items-center gap-3 px-2 py-1.5 pr-3 rounded-xl transition-all border ${showProfileMenu ? "bg-indigo-50 border-indigo-200 shadow-inner" : "bg-white border-transparent hover:bg-slate-50"}`}
            >
            ...
            {showProfileMenu && (
              <div className="absolute right-0 mt-3 w-60 bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 py-2 animate-fade-in origin-top-right z-50">
                ...
                <Link
                  ...
                  className="flex items-center gap-3 px-4 py-2.5 mx-2 rounded-xl text-slate-600 font-medium hover:bg-indigo-50 hover:text-indigo-600 transition-colors"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            ...
            className="relative group flex items-center justify-center w-12 h-12 rounded-xl hover:bg-indigo-50 transition-all border border-transparent hover:border-indigo-100"
          >
            <div className="relative">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 text-slate-600 group-hover:text-indigo-600 transition-colors"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              {cartCount > 0 && (
                <span className="absolute -top-2 -right-2 bg-indigo-600 text-white text-[10px] font-bold rounded-lg min-w-[18px] h-[18px] flex items-center justify-center border-2 border-white shadow-sm ring-1 ring-indigo-600/20">
                  {cartCount}
                </span>
              )}
            </div>
                ...
                return (
                  <div key={catId} className="relative group h-full flex items-center">
                    <button
                      ...
                      className="px-4 py-3 text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-1.5 rounded-lg text-slate-500 hover:text-indigo-600 group-hover:text-indigo-600"
                    >
                      {category.name}
                      {hasChildren && (
