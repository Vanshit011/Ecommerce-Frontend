            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-slate-100 pt-6">
              <div className="flex items-center gap-4">
                <p className="text-xs text-slate-500">
                  ...
                  of <span className="font-semibold text-slate-800">{totalItems}</span> orders
                </p>
                    ...
                    if (
                      ...
                      return (
                        <button
                          ...
                          className={`w-8 h-8 flex items-center justify-center rounded-lg border font-medium text-xs transition-all ${
                            page === pageNum
